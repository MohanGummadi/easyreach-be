...
public class EquipmentUsageServiceImpl extends CompanyScopedService implements EquipmentUsageService {
    ...
    public ApiResponse<EquipmentUsageResponseDto> create(EquipmentUsageRequestDto dto) {
        ...
        ApiResponse<EquipmentUsageResponseDto> response = ApiResponse.success(mapper.toDto(repository.save(entity)));
    ...
    public ApiResponse<EquipmentUsageResponseDto> update(String id, EquipmentUsageRequestDto dto) {
        ...
        EquipmentUsage e = repository.findByEquipmentUsageIdAndCompanyUuidAndDeletedIsFalse(id, currentCompany())
                .orElseThrow(() -> {
                    log.error("EquipmentUsage not found: {}", id);
                    return new EntityNotFoundException("EquipmentUsage not found: " + id);
                });
        mapper.update(e, dto);
        ApiResponse<EquipmentUsageResponseDto> response = ApiResponse.success(mapper.toDto(repository.save(e)));
    ...
    public ApiResponse<EquipmentUsageResponseDto> get(String id) {
        ...
        ApiResponse<EquipmentUsageResponseDto> response = ApiResponse.success(mapper.toDto(e));
    ...
    public ApiResponse<Page<EquipmentUsageResponseDto>> list(Pageable pageable) {
        ...
        ApiResponse<Page<EquipmentUsageResponseDto>> response = ApiResponse.success(repository.findByCompanyUuidAndDeletedIsFalse(currentCompany(), pageable).map(mapper::toDto));
